...
//собирает карточку
function createCard(imageSource, imageAlt, cardText, handleCardDelete, handleClick, popupOpenFunc) {
...
function handleAddCardFormSubmit(evt) {
    ...
    placesList.prepend(createCard(imageSrc, "Alt", imageName, handleCardDelete, likeButtonHandleClick, popupOpenFunc));
...
export { handleCardDelete, createCard, initialCards, handleAddCardFormSubmit, likeButtonHandleClick, popupOpenFunc };
